...
Branch isolada -> CI e Preview -> revisão humana -> merge. Nenhuma mudança de schema ou dados é necessária.

## Observabilidade

Se o novo gate falhar, tratar como regressão de contrato do domínio de pedidos e bloquear promoção até que o caller incorreto seja removido.
