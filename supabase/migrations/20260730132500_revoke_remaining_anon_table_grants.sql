...
-- Historical hosted environments contain optional tables/views that are not
-- part of every clean installation. Revoke anon access from every relation
-- that actually exists without making bootstrap depend on manual legacy state.
do $$
declare
  relation_name text;
begin
