...
-- These RPCs existed in the legacy Production database before this point in the
-- tracked history. Grant them when present; clean environments create and grant
-- the hardened implementations in the later 20260803 migrations.
do $$
begin
