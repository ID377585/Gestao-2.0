...
begin
  ...
  return jsonb_build_object(
    'ok',
      ...
      and jsonb_array_length(v_anon_table_grants) = 0
    ...
    'contract_version', 'gestify-core-v1',
    'checked_at', pg_catalog.clock_timestamp(),
    'public_tables_without_rls', v_tables_without_rls,
    'anon_table_grants', v_anon_table_grants,
...
comment on function public.gestify_core_security_audit() is
  'Service-role-only live security contract for public-table RLS, anonymous grants, internal tables, critical RPCs and public storage buckets.';
